...
\begin{abstract}
\noindent \normalfont Wordle is a daily word game in which a player must guess a hidden five-letter word in six or fewer tries. After each guess, they get a color-coded response that indicates how close their guess was. This paper describes a solver that wins all 2,315 possible games, averaging a score of 3.596 with a standard deviation of 0.679. This is comparable to the current-best solvers, yet is achieved heuristically with many fewer calculations.
...
%\begin{figure}[h!]
%  \centering
%    \includegraphics[width=0.5\textwidth]{p_vs_v.eps}
